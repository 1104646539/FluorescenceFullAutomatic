...
namespace FluorescenceFullAutomatic.Platform.Services
{
    ...
    public interface ISerialPortService
    {
        ...
        // ÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔø?
        void GetSampleShelf();
        void MoveSampleShelf(int pos);
        
        // ÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔø?
    ...
    public sealed class SerialPortCommandFacade : ISerialPortCommandFacade, IReceiveData
    {
        ...
        )
        {
            ...
            lock (_gate)
            {
                ...
                {
                    throw new InvalidOperationException($"¥Æø⁄÷ÿ∑¢ √¸¡Ó={cmd}");
                }
        ...
        )
        {
            ...
            try
            {
                ...
                var ex = new TimeoutException($"¥Æø⁄Ω” ’≥¨ ± √¸¡Ó={cmd} ≥¨ ± ±º‰={timeoutMs}ms");
