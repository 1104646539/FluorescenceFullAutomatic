...
namespace FluorescenceFullAutomatic.Sql
{
    ...
    */
        ...
        private void CodeFirstInit()
        {
            ...
            db.Db.CopyNew().CodeFirst.InitTables<TestResult, Project, Model.Point, Patient, ApplyTest>();
            db.Db.CopyNew().CodeFirst.InitTables<SqlVersion>();
        ...
        public SqlVersion GetSqlVersion(string versionName)
        {
            return db.Db.CopyNew().Queryable<SqlVersion>().Where(t => t.Name == versionName).Single();
        }
        ...
        /// <returns></returns>
        public int InsertPoint(Model.Point point)
        {
        ...
        /// <returns></returns>
        public Model.Point GetPoint(int pointId)
        {
            return db.Db.CopyNew().Queryable<Model.Point>().Where(p => p.Id == pointId).Single();
        }
        ...
        /// <param name="point"></param>
        /// <returns></returns>
        public bool UpdatePoint(Model.Point point)
        {
