...
namespace FluorescenceFullAutomatic.Config
{
    public class SystemGlobal
    {
        ...
        /// 默认的模板文件路径
        /// </summary>
        public static string Template_Path = GlobalUtil.GetCurrentProjectPath + @"/template/A4.xlsx";
        /// <summary>
        /// 默认的双联卡模板文件路径
        /// </summary>
        public static string DoubleTemplate_Path = GlobalUtil.GetCurrentProjectPath + @"/template/A4-双联卡.xlsx";
        /// <summary>
        /// 默认的缓存路径
        /// </summary>
        public static string Cache_Path = GlobalUtil.GetCurrentProjectPath + @"/cache";
    }
