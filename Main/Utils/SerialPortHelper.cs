...
namespace FluorescenceFullAutomatic.Utils
{
    public class SerialPortHelper : ISerialPort
    {
        ...
        private SerialPortHelper(ISerialPort serialPort)
        {
            ...
            this.SerialPort.SerialPortConnectExceptionReceived += SerialPort_SerialPortConnectExceptionReceived;
        ...
        private void SerialPort_SerialPortConnectExceptionReceived(string obj)
        {
            //连接异常
            SerialPortConnectExceptionReceived?.Invoke(obj);
        }
