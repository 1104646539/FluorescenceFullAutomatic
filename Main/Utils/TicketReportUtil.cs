...
{
    public class TicketReportUtil : ISerialPort
    {
        private static readonly Lazy<TicketReportUtil> _instance = new Lazy<TicketReportUtil>(
            () => SystemGlobal.IsCodeDebug ? new TicketReportUtil(
                  new FakaTicketSerialPort()
                ) : new TicketReportUtil(
                  new SerialPortImpl()
                ));

        public static TicketReportUtil Instance => _instance.Value;
        ...
        private TicketReportUtil(ISerialPort serialPort)
        {
            this.SerialPort = serialPort;
            this.SerialPort.DataReceived += SerialPort_DataReceived;
            this.SerialPort.SerialPortConnectReceived += SerialPort_SerialPortConnectReceived;
            this.SerialPort.SerialPortConnectExceptionReceived += SerialPort_SerialPortExceptionReceived;
